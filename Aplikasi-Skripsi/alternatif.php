                            ...
                            <div class="box-wrapper-again">
                                <div class="box-main">
                                    ...
                                    <div class="welcome-table">
                                            ...
                                            <button><a href="input_alternatif.php" class="btn btn-add">Tambah</a></button>
                                            <table>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Nama</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['Nilai_IPA']; ?></td>
                                                    <td><?php echo $row['Nilai_IPS']; ?></td>
                                                    <td><?php echo $row['Umur']; ?></td>
                                                    <td><a class="btn btn-edit" href="edit_alternatif.php?id=<?php echo $row['id']; ?>">Edit</a></td>
                                                    <td><a class="btn btn-hapus" href="hapus_alternatif.php?id=<?php echo $row['id']; ?>">Hapus</a></td>
                                                </tr>
                                                <?php 
                                                    }
                                                ?>
