                                        ...
                                        <div class="welcome-table">
                                            <h1>Kriteria WP</h1><br>
                                                <?php 
                                                    include "config.php";
                                                    $id = $_GET['id'];
                                                    $query_mysql = $conn->query("SELECT * FROM krit_wp WHERE id='$id'")or die(mysql_error());
                                                    $nomor = 1;
                                                    while($row = mysqli_fetch_array($query_mysql)){
                                                ?>
                                                <form action="edit_aksi_wp.php" method="post">		
                                                    <table>
                                                        <tr>
                                                            <td>Nama Kriteria</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" name="Bobot_Kriteria" value="<?php echo $row['Bobot_Kriteria'] ?>"></td>					
                                                        </tr>
                                                            <td></td>
