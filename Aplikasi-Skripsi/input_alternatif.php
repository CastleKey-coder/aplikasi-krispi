                                ...
                                <div class="box-main">
                                    ...
                                    <div class="dashmenu">
                                        <div class="welcome-table">
                                            <h1>Alternatif</h1><br>
                                            <form action="input_aksi_alternatif.php" method="post">		
                                                <table>
                                                    <tr>
                                                        <td>Nama</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="Nilai_MM"></td>					
                                                    </tr>
                                                    <tr>
                                                        <td>Nilai IPA</td>
                                                        <td><input type="text" name="Nilai_IPA"></td>					
                                                    </tr>
                                                    <tr>
                                                        <td>Nilai IPS</td>
                                                        <td><input type="text" name="Nilai_IPS"></td>					
                                                    </tr>
                                                    <tr>
                                                        <td>Umur</td>
