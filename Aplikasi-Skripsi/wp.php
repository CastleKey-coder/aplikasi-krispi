                                ...
                                <div class="box-main">
                                    <div class="sidebar">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="wp.php" class="active" href="#">
                                    ...
                                    <div class="dashmenu">
                                        <div class="welcome-table">
                                            <h1>Kriteria WP</h1><br>
                                            <button><a href="input_wp.php" class="btn btn-add">Tambah</a></button>
                                            <table>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Nama Kriteria</th>
                                                ...
                                                <?php 
		                                            ...
		                                            $data = mysqli_query($koneksi,"select * from krit_wp");
		                                            $no = 1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-edit" href="edit_wp.php?id=<?php echo $row['id']; ?>">Edit</a></td>
                                                    <td><a class="btn btn-hapus" href="hapus_wp.php?id=<?php echo $row['id']; ?>">Hapus</a></td>
                                                </tr>
                                                <?php 
                                                    }
                                                ?>
